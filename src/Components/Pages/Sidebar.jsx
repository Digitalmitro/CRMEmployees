 ...
 const handleSidebarOk = async () => {
  ...
  return (
    <div className="sidebar ">
      ...
      {context.toggleSidebar?( <Tooltip  title="Home">
        <li  >
...
{context.toggleSidebar?( <Tooltip  title="Attendence">
...
{context.toggleSidebar?( <Tooltip  title="Projects">
...
{context.toggleSidebar?( <Tooltip  title={project.projectName}>
...
{context.toggleSidebar?( <Tooltip  title="Callbacks">
...
{context.toggleSidebar?( <Tooltip  title="Transfers">
...
{context.toggleSidebar?( <Tooltip  title="Sales">
        ...
        {context.toggleSidebar?(<Tooltip  title="Notes">
...
{context.toggleSidebar?( <Tooltip  title="Send Messages">
...
//             ))}
//             <li>
//               <Button type="primary" onClick={showSidebarModal}>
//                 Add Project
//               </Button>
//             </li>
//           </ul>
